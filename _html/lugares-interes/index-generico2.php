...
<html lang="es">
    ...
    <body class="bg-<?= COLOR_PAGE; ?>-100">
        ...
        <?php require PATH_DOMINIO_RAIZ . "/_estructura/semantica/body/header/header-generico.php"; ?>
        
        <?php require PATH_DOMINIO_RAIZ . "/_html/lugares-interes/post-header-generico.php"; ?>
        ...
        <?php //require PATH_LOCALIDAD_LUGARES_INTERES_PLAYAS_SCHEMAS_PLAYAS_NOMBRE_PLAYA . "/schemas-body.php"; ?>
