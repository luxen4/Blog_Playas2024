...
$archivo_name = 'bakio-bakio-bizkaia';
...
$region = 'Bizkaia';  // Usa "Bizkaia" si esa es tu convención oficial
$region_minuscula = strtolower($region);  // "bizkaia"
$archivo_name = 'astondoko-gorliz-bizkaia';

$presentacion = '🌿 La Playa de Astondoko, también conocida como Astondo o Playa de Astondoko, es una playa natural situada junto a Gorliz, bizkaia. Destaca por su entorno salvaje, sus vistas espectaculares y la tranquilidad que ofrece. Es ideal para pasear, desconectar y explorar la costa vasca más auténtica.';
...
$region_minuscula = strtolower($region);  // "bizkaia"
$archivo_name = 'laga-ibarrangelu-bizkaia';
