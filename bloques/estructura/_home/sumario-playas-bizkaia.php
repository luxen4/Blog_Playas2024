...
<?php
$playa_name = 'Playa de Bakio'; $localidad_minuscula = strtolower(str_replace(' ', '-', $playa_name)); $archivo_name = 'bakio-bakio';
...
<?php
$playa_name = 'Playa de Astondo'; $localidad_minuscula = strtolower(str_replace(' ', '-', $playa_name)); $archivo_name = 'astondo-gorliz';
...
<?php
$playa_name = 'Playa de Laga'; $localidad_minuscula = strtolower(str_replace(' ', '-', $playa_name)); $archivo_name = 'laga-ibarrangelu';
...
<?php
$playa_name = 'Playa de La Arena'; $localidad_minuscula = strtolower(str_replace(' ', '-', $playa_name)); $archivo_name = 'la-arena-muskiz';
...
<?php
$playa_name = 'Playa de Arrietara'; $localidad_minuscula = strtolower(str_replace(' ', '-', $playa_name)); $archivo_name = 'arrietara-sopelana';
...
<?php
$playa_name = 'Playa de Plentzia'; $localidad_minuscula = strtolower(str_replace(' ', '-', $playa_name)); $archivo_name = 'plentzia-plentzia';
