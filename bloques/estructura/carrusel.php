...
include $_SERVER['DOCUMENT_ROOT']. '/Blog_Playas2024/products_amazon/sneakers.php';

$table='amazon_swimsuits_woman_images';
$where = 'order by direccion';
include $_SERVER['DOCUMENT_ROOT']. '/Blog_Playas2024/products_amazon/swimsuits_woman.php';

$table='amazon_sandals_man_images';
$where = 'order by direccion';
include $_SERVER['DOCUMENT_ROOT']. '/Blog_Playas2024/products_amazon/sandals_man.php';

$table='amazon_shorts_images';
$where = 'where direccion = "frente"';
include $_SERVER['DOCUMENT_ROOT']. '/Blog_Playas2024/products_amazon/shorts_man.php';

$table='amazon_sports_shirts_images';
$where = 'where marca = "Pepe Jeans" and direccion = "modelo_frente_izquierda"';
include $_SERVER['DOCUMENT_ROOT']. '/Blog_Playas2024/products_amazon/sports_shirts.php';

$table='amazon_shirts_images';
$where = 'where direccion = "modelo_frente"';
include $_SERVER['DOCUMENT_ROOT']. '/Blog_Playas2024/products_amazon/sports_shirts2.php';
