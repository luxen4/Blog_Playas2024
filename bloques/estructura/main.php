    ...
    <div class="row"> <!-- Añadido el contenedor de fila -->
        ...
        <div id="central-column" class="col-xl-8 col-lg-9 col-md-12 col-sm-12 col-12 content-wrapper">
            <main>
              ...
              <?php require PATH_RAIZ_BLOQUES_ESTRUCTURA.'/main/bloque_con_boton_actividades.php'; ?>
              <?php require PATH_RAIZ_BLOQUES_ESTRUCTURA.'/main/bloque_con_boton_como_llegar.php'; ?>
              <?php require PATH_RAIZ_BLOQUES_ESTRUCTURA.'/main/bloque_con_boton_servicios.php'; ?>
              <?php require PATH_RAIZ_BLOQUES_ESTRUCTURA.'/main/bloque_con_boton_eventos_festividades.php'; ?>

              <?php require PATH_RAIZ_BLOQUES_ESTRUCTURA.'/main/bloque_con_boton_faqs_consejos.php'; ?>
