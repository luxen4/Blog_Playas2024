<main class="bg-emerald-50 min-h-screen p-4 md:p-10">
  ...
  <?php require PATH_RAIZ_LOCALIDAD_LUGARES_INTERES_BODY_DATA . '/data-galeria-dinamica-imagenes.php'; ?>
  <?php require PATH_RAIZ_BLOQUES_ESTRUCTURA_PAGINAS_GENERICO . '/print-galeria-dinamica-imagenes.php'; ?>

  <?php //require PATH_RAIZ_LOCALIDAD_LUGARES_INTERES_BODY_DATA . '/data-openweather.php'; 
  ?>
  <?php //require PATH_RAIZ_BLOQUES_ESTRUCTURA_PAGINAS_GENERICO . '/print-openweather-generico.php'; 
  ?>

  <?php require PATH_RAIZ_LOCALIDAD_LUGARES_INTERES_BODY_DATA . '/data-comentarios-simulados.php'; ?>
  ...
  <?php require PATH_RAIZ_LOCALIDAD_LUGARES_INTERES_BODY_DATA . '/data-actividades.php'; ?>
  <?php require PATH_RAIZ_BLOQUES_ESTRUCTURA_PAGINAS_GENERICO . '/print-actividades-generico.php'; ?>

  <?php require PATH_RAIZ_LOCALIDAD_LUGARES_INTERES_BODY_DATA . '/data-mapa.php'; ?>
...
<iframe src="https://www.google.com/maps/d/embed?mid=1L4SEO97SALcMFfuGKJylOveGmwvXoRg&ehbc=2E312F" width="640" height="480"></iframe> */ ?>
  ...
  <?php require PATH_RAIZ_LOCALIDAD_LUGARES_INTERES_BODY_DATA . '/data-contacto.php'; ?>
