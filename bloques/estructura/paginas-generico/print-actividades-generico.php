<section class="mb-10">
  ...
  <ul class="grid md:grid-cols-2 gap-4">
    <?php foreach ($actividades["items"] as $actividad): ?>
      <li class="bg-white p-3 rounded-xl shadow border-l-4 border-emerald-600 hover:shadow-lg transform hover:scale-105 transition duration-300 ease-in-out flex items-center gap-3">
