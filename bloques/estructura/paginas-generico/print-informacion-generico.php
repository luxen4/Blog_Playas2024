...
<section class="mb-12">
  ...
  <div class="grid md:grid-cols-2 gap-6">
    <?php foreach($info['items'] as $item): ?>
      <div class="bg-white rounded-xl p-1 shadow border-l-4 border-emerald-600 flex items-start gap-3 transform hover:scale-105 transition duration-300 ease-in-out">
