    ...
    <div class="row"> <!-- Añadido el contenedor de fila -->
      ...
      <?php require PATH_DOMINIO_RAIZ . '/_estructura/semantica/componentes/breadcrums-generico.php'; ?>
            ...
            <main>
              ...
              <?php require PATH_LOCALIDADES_SECTIONS_VARIABLES . '/encabezado.php'; ?>

              <?php require PATH_BLOQUES_SECTIONS_CARRUSELES_CSV.'/prueba_sports_shirts_hombre.php'; ?>
              <?php require PATH_LOCALIDADES_SECTIONS_VARIABLES . '/descripcion.php'; ?>

              <?php require PATH_BLOQUES_SECTIONS_GENERICO.'/helpers/render_bloques.php'; ?>

              <?php require PATH_BLOQUES_ESTRUCTURA_PAGINAS_PLAYA_BODY_MAIN.'/renderizado-sections.php'; ?>
              ...
              <?php require PATH_LOCALIDADES_SECTIONS_VARIABLES . '/mas-informacion.php'; ?>
