...
// Twitter Cards
$twitterCards_image                     = PATH_RAIZ_LOCALIDADES_CARPETA . "/lugares-interes/{$lugar_interes}/img/{$lugar_interes}.jpg";
$twitterCards_url                       = PATH_RAIZ_LOCALIDADES_CARPETA . "/lugares-interes/{$lugar_interes}/index.php"; 
