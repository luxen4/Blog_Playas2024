...
$arrayElementos = array(
    ...
    array("nombre" => "dress_woman", "tipoPublicidad" => "3"),
    array("nombre" => "jeans_man", "tipoPublicidad" => "vertical"),
    array("nombre" => "shorts", "tipoPublicidad" => "horizontal"),
    array("nombre" => "sneakers", "tipoPublicidad" => "vertical"),
    array("nombre" => "sports_shirts", "tipoPublicidad" => "horizontal"),
    array("nombre" => "vaqueros_hombre", "tipoPublicidad" => "vertical")
);
...
function leer_CSV_chaquetas_hombre($nombre) {
...
function leer_CSV_botas_hombre($arrayElementos, $numeroAleatorio) {
    $csv_file = './../../../../bloques/estructura/sections_generico/csv_publicidad_amazon/amazon_' . $arrayElementos[$numeroAleatorio]["nombre"] . '_images.csv';
    $productos = [];
...
function leer_CSV_sorts($arrayElementos, $numeroAleatorio) {
    $csv_file = './../../../../bloques/estructura/sections_generico/csv_publicidad_amazon/amazon_' . $arrayElementos[$numeroAleatorio]["nombre"] . '_images.csv';
    $productos = [];
