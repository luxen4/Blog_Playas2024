...
$description_content = 'Explora la Playa de Castro Urdiales, un hermoso destino costero en el norte de España. Ideal para disfrutar del sol, el mar y la rica cultura de la región.';
$keywords_content = 'Playa de Castro Urdiales, costa norte, sol, mar, turismo en España, Castro Urdiales';
...
<?php /*
<head>
    <title>Playa de Castro Urdiales - Castro Urdiales, España</title>

    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="site-verification" content="e148bdbc89c019bd06122ab7bd08a8be" />
    <meta name="description" content="Explora la Playa de Castro Urdiales, un hermoso destino costero en el norte de España. Ideal para disfrutar del sol, el mar y la rica cultura de la región.">
    <meta name="keywords" content="Playa de Castro Urdiales, costa norte, sol, mar, turismo en España, Castro Urdiales">
...
<body>
    ...
    <div class="container my-5">
        <h1 class="text-center">Castro Urdiales</h1>

        <section id="descripcion" class="my-4">
            <h2>Descripción</h2>
    ...
    <h2 class="mb-4 text-center">Actividades en Castro Urdiales</h2>
    <p>Castro Urdiales es un lugar vibrante y lleno de posibilidades para disfrutar del tiempo libre. Aquí tienes algunas de las actividades más destacadas que puedes realizar en esta hermosa localidad costera.</p>
...
<section id="servicios" class="container my-5">
    <h2 class="mb-4 text-center">Servicios en Castro Urdiales</h2>
    <p>Castro Urdiales ofrece una amplia gama de servicios para garantizar una experiencia cómoda y agradable para todos sus visitantes. A continuación, te presentamos algunos de los servicios más destacados.</p>
    ...
    <main class="container my-4">
        ...
        <h6 id="contacto">Para más información puede consultar en la pagina de la Oficina de Turismo de 
                    <a href="https://turismo.castro-urdiales.net/">Castro Urdiales</a>
                </h6>
