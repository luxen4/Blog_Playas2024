...
<div id="#" class="container">
    <div class="row">
        ...
        <a href="./../../../../bloques/amazon_interfaz_enlaces.php" target="_blank">
            ...
            <hr><?php include './../../../../bloques/carrusel_horizontal_fijo_swimsuits_woman_amazon.php'; // Carrusel fijo de camisetas UNDER ARMOUR ?><hr>
            ...
            <hr><?php include './../../../../bloques/carrusel_horizontal_fijo_sports_shirts_amazon.php'; // Carrusel fijo de camisetas UNDER ARMOUR ?><hr>
            ...
            <hr><?php include './../../../../bloques/carrusel_horizontal_fijo_shorts.php'; // Carrusel fijo de shorts Tansozer ?><hr>
