...
////////
// Para el archivo Structured_data_generico
$localidad = 'Berria'; $localidad_minuscula = 'berria';
...
$mainEntity_addressLocality = 'Santoña'; $mainEntity_addressRegion = 'Cantabria'; $mainEntity_addressCountry = 'España';

$mainEntity_geo_latitude = 43.4672; $mainEntity_geo_longitude = -3.4366;
...
<?php 
    ...
    <section class="container">
        ...
        <ul>
            ...
            <?php $articulo = 'shorts'; $grupo = '_2'; include BASE_PATH_ESTRUCTURA . 'carrusel_auxiliar.php'; ?>
    ...
    <?php
    $articulo = 'sneakers_izquierda_15'; $grupo = '_2';
    include BASE_PATH_ESTRUCTURA . 'carrusel_auxiliar.php'; ?>
    ...
    <?php $articulo = 'swimsuits_woman'; $grupo = '_2'; include BASE_PATH_ESTRUCTURA . 'carrusel_auxiliar.php'; ?>
