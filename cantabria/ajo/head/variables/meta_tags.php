...
$pinterest_property_card_title_content       = 'Ajo, Cantabria';
$pinterest_property_card_description_content = 'Descubre Ajo en Cantabria: con una playa abierta al Cantábrico ideal para surfistas, familias y amantes del paisaje natural cántabro.';
$pinterest_property_card_image_content       = PATH_DOMINIO_RAIZ . '/'.$region_minuscula.'/'.$localidad_minuscula.'/img/ajo-cantabria.png';

// Twitter Cards
$twitterCards_card        = SUMARY_LARGE_IMAGE;
$twitterCards_site        = '@laya_garcia';
$twitterCards_title       = 'Ajo, Cantabria';
...
$twitterCards_image       = PATH_DOMINIO_RAIZ . '/'.$region_minuscula.'/'.$localidad_minuscula.'/img/ajo-cantabria.png';
$twitterCards_url         = PATH_DOMINIO_RAIZ . '/'.$region_minuscula.'/'.$localidad_minuscula;

// Open Graph
$graph_Meta_Tags_property_title        = 'Ajo, Cantabria';
$graph_Meta_Tags_property_description  = 'Visita Ajo, con una playa de arena dorada rodeada de naturaleza, ideal para desconectar y disfrutar del Cantábrico.';

$graph_Meta_Tags_property_image        = PATH_DOMINIO_RAIZ . '/'.$region_minuscula.'/'.$localidad_minuscula.'/img/ajo-cantabria.png';
...
$graph_Meta_Tags_property_image_alt    = 'Ajo, Cantabria';
...
$graph_Meta_Tags_property_tag          = 'Ajo, Cantabria';
