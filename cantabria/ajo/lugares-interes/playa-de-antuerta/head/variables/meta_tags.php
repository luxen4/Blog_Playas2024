...
$pinterest_property_card_image_content       = PATH_LOCALIDAD . '/'.$region.'/'.$localidad.'/img/'.LUGAR_MINUSCULA.'-'.$localidad_minuscula.'-'.$region_minuscula.'-1.jpg';
...
$twitterCards_image       = PATH_LOCALIDAD . '/'.$region.'/'.$localidad.'/img/'.LUGAR_MINUSCULA.'-'.$localidad_minuscula.'-'.$region_minuscula.'-1.jpg';
$twitterCardSs_url         = PATH_LOCALIDAD . '/'.$region.'/'.$localidad.'/index.php'; // Puedes usar un slug más específico si lo tienes
...
$graph_Meta_Tags_property_url   = PATH_LOCALIDAD.'/index.php';
