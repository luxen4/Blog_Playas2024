...
$pinterest_property_card_image_content       = PATH_LOCALIDAD . '/castro-urdiales.jpg';
?>
...
$twitterCards_image       = PATH_LOCALIDAD . '/img/puerto-pesquero-castro-urdiales-cantabria-1.jpg';
$twitterCards_url         = PATH_LOCALIDAD . '/index.php';
?>
...
$graph_Meta_Tags_property_image       = PATH_LOCALIDAD . "/{$region_minuscula}/{$localidad_minuscula}/img/castro-urdiales.jpg";
$graph_Meta_Tags_property_url         = PATH_LOCALIDAD . "/{$region_minuscula}/{$localidad_minuscula}/index.php";
