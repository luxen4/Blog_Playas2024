...
$graph_Meta_Tags_property_image = PATH_LOCALIDAD . '/img/senderos-castro.jpg';
$graph_Meta_Tags_property_url = PATH_LOCALIDAD . "/{$region_minuscula}/{$localidad_minuscula}/senderos-costeros-rutas-oficiales.php";
...
$pinterest_property_card_image_content = PATH_LOCALIDAD . '/img/senderos-castro.jpg';
?>
...
$twiterCards_image = PATH_LOCALIDAD . '/img/senderos-castro.jpg';
$twiterCards_url = PATH_LOCALIDAD . "/{$region_minuscula}/{$localidad_minuscula}/senderos-costeros-rutas-oficiales.php";
?>
...
$url = PATH_LOCALIDAD . "/{$region_minuscula}/{$localidad_minuscula}/senderos-costeros-rutas-oficiales.php";
...
$mainEntity_image = PATH_LOCALIDAD . '/img/senderos-castro.jpg';
$mainEntity_url = $url;
?>
