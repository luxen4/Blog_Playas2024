...
require PATH_WEB_PLAYA . "/meta_tags.php";        // Variables de etiquetas meta
require PATH_WEB_PLAYA . "/tweeter.php";          // Variables Twitter
require PATH_WEB_PLAYA . "/pinterest.php";        // Variables Pinterest
require PATH_WEB_PLAYA . "/data-generico.php";    // Variables para el archivo Structured_data_generico.php

// Imagen representativa y URL canónica
require PATH_WEB_PLAYA . "/structure-data-schema-org.php";

require PATH_BLOQUES_ESTRUCTURA . "/head.php"; ?>

<body>
    <?php $page = 'playade' . $nombre_playa_minuscula; ?>
    <?php require "./sections/info.php"; ?>
    <?php require PATH_BLOQUES_ESTRUCTURA . "/body_generico.php"; ?>
</body>
