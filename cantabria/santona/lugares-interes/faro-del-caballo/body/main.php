...
<head>
  ...
  <?php require PATH_LOCALIDADES . "/{$region_minuscula}/{$localidad_minuscula}/lugares-interes/faro-del-caballo-santona/schemas/schemas-head.php"; ?>
</head>
...
<body class="bg-gray-50 text-gray-800">
  ...
  <?php require PATH_LOCALIDADES . "/{$region_minuscula}/{$localidad_minuscula}/lugares-interes/faro-del-caballo-santona/schemas/schemas-body.php"; ?>
</body>
</html>
