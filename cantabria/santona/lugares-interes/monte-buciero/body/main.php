...
<head>
  ...
  <?php require PATH_LOCALIDADES . "/{$region_minuscula}/{$localidad_minuscula}/lugares-interes/{$lugar_minuscula}/schemas/schemas-head.php"; ?>
</head>
...
<body class="bg-gray-50 text-gray-800">
  ...
  <?php require PATH_LOCALIDADES . "/{$region_minuscula}/{$localidad_minuscula}/lugares-interes/{$lugar_minuscula}/schemas/schemas-body.php"; ?>
</body>
</html>
