...
$region_minuscula = 'nouvelle-aquitaine'; $region_minuscula = 'francia'; // Usar minúsculas para URLs amigables
$country = 'Francia';
$rutas = 'playa-de-biarritz-francia'; // URL slug amigable y SEO-friendly
$hoy = date('Y-m-d');
?>