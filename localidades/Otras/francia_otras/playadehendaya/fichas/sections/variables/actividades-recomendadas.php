...
<section id="actividades" class="seccion-actividades container">
  <a class="nav-link text-red" href="/Blog_Playas2026/<?= $rutas; ?>">Playa de Hendaya</a>
  ...
  <h5><i class="fas fa-sun" style="color: #f1c40f;"></i> Aventura y Naturaleza en Hendaya</h5>
  <p class="section-content">
    La <strong>Playa de Hendaya</strong> es famosa por su <strong>gran amplitud, arena fina y oleaje moderado</strong>, lo que la convierte en un lugar ideal para <strong>surfistas principiantes y familias</strong>. También es un punto destacado para <strong>bodyboard y kayak de mar</strong>.
  </p>
  ...
  <div class="info-box">
    <ul class="list-unstyled">
      <li>
        ...
        <strong>Surf y Bodyboard en Hendaya:</strong><br>
        Con olas accesibles y gran seguridad, es una de las playas preferidas del País Vasco francés para <strong>iniciarse en el surf</strong>. Las escuelas están abiertas desde <time datetime="2025-05">mayo</time> hasta <time datetime="2025-10">octubre</time>.
      </li>

      <li class="my-4">
        <i class="fas fa-hiking" style="color: #27ae60;"></i>
        <strong>Senderismo por la Cornisa Vasca:</strong><br>
      ...
      <li class="my-4">
        ...
        Vive una experiencia única navegando por la bahía entre Hendaya e Irún. Hay salidas diarias desde el puerto deportivo o excursiones hacia Hondarribia. Mejor época: <time datetime="2025-06">junio</time> – <time datetime="2025-09">septiembre</time>.
      </li>

      <li class="my-4">
        <i class="fas fa-volleyball-ball" style="color: #e67e22;"></i>
        <strong>Deportes en la arena:</strong><br>
        La playa cuenta con instalaciones para <strong>voleibol, fútbol y yoga</strong>. También se organizan clases dirigidas de <strong>fitness frente al mar</strong> durante la temporada estival.
      </li>
    </ul>
  </div>
</section>
