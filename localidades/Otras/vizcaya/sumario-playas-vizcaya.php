...
<details>
    ...
    $archivo_name = 'getxo';
    $presentacion = 'La Playa de Getxo, situada en la costa de vizkaia, es un popular destino costero del País Vasco. Con su amplia oferta de actividades acuáticas, espectaculares vistas del mar Cantábrico, y una vibrante vida cultural y gastronómica, Getxo es ideal tanto para los amantes del surf como para quienes buscan relajarse y disfrutar de su entorno natural.';
    include $targeta; ?>
    ...
    $archivo_name = 'laga';
    $presentacion = 'La Playa de Laga, ubicada en la costa de vizkaia en el País Vasco, es un paraíso natural dentro del Parque Natural de Urdaibai, una Reserva de la Biosfera declarada por la UNESCO. <br>Con su arena dorada y su entorno rodeado de acantilados y vegetación exuberante, es un destino perfecto para quienes buscan tranquilidad y belleza natural.<br>Además, es popular entre los surfistas gracias a sus olas y es ideal para el senderismo y la observación de aves. <br>La playa de Laga ofrece una experiencia única donde la naturaleza y el mar se encuentran en su máximo esplendor.';
    include $targeta; ?>
