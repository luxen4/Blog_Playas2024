<script type="application/ld+json">
{
  ...
  "url": "https://<?= $_SERVER['SERVER_NAME'] ?>/Blog_Playas2026/localidades/<?= $region_minuscula ?>/<?= $localidad_minuscula; ?>/fichas/playa-de-<?= $nombre_playa_minuscula . "-" . $localidad_minuscula . "-" . $region_minuscula ?>.php",
  "touristType": {
    "@type": "Audience",
