<?php 
  $intro = [
    ...
    "imagenes" => [
      [
        "src" => PATH_HREF_RAIZ_LOCALIDAD_LUGARES_INTERES_IMG . "/parque-natural-montes-triano-1.jpg",
        "alt" => "Senderos y áreas verdes del Parque Natural de los Montes de Triaño"
      ],
      [
        "src" => PATH_HREF_RAIZ_LOCALIDAD_LUGARES_INTERES_IMG . "/parque-natural-montes-triano-2.jpg",
