<main>
  ...
  <section aria-labelledby="actividades-cuberris" class="mb-8">
    ...
    <p class="mb-4 text-sm text-gray-700 flex items-start gap-2">
      <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
        <path fill-rule="evenodd" d="M12 2a10 10 0 100 20 10 10 0 000-20zm4.03 6.97a.75.75 0 00-1.06-1.06L11 11.94l-1.47-1.47a.75.75 0 10-1.06 1.06l2 2a.75.75 0 001.06 0l4.5-4.5z" clip-rule="evenodd"/>
      </svg>
  ...
  <section id="actividades-cuberris" aria-labelledby="titulo-cuberris-galeria" class="my-10">
    <h2 id="titulo-cuberris-galeria" class="text-xl font-semibold text-blue-700 mb-3">
      Imágenes de la Playa de Cuberris en Ajo, Cantabria
    </h2>
