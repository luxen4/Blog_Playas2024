...
<main class="container py-5 mx-auto max-w-7xl">  
  <div class="bg-white rounded-2xl shadow-md p-6 md:p-10">
    ...
    <p class="mb-4 text-gray-700">Situado cerca del puerto y la plaza principal, el Palacio Ochagarán destaca por su fachada con escudos heráldicos y su impresionante estructura, que transporta a los visitantes a épocas pasadas.</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-8">
      <img src="<?= PATH_HREF_RAIZ_LOCALIDAD_LUGARES_INTERES_IMG; ?>/palacio-ochagaran.jpg" alt="Imagen del Palacio Ochagarán" class="rounded-lg shadow-sm object-cover w-full h-64">
      <img src="<?= PATH_HREF_RAIZ_LOCALIDAD_LUGARES_INTERES_IMG; ?>/palacio-ochagaran.jpg" alt="Imagen del Palacio Ochagarán" class="rounded-lg shadow-sm object-cover w-full h-64">
    </div>
    <p class="text-center text-sm text-gray-500 mb-8">Imágenes del Palacio Ochagarán en Castro Urdiales</p>

    <p class="mb-6 text-gray-700">El Palacio Ochagarán representa la riqueza histórica y cultural de Castro Urdiales, siendo una parada esencial para los amantes de la arquitectura y la historia local.</p>
    ...
    <p class="mb-8 text-gray-700">Visitar el Palacio Ochagarán es sumergirse en la historia señorial de Castro Urdiales y disfrutar de su arquitectura tradicional cántabra.</p>
