      ...
      <div class="swiper mySwiper rounded-lg shadow-md">
        <div class="swiper-wrapper">
          <div class="swiper-slide h-72">
            <img src=<?= PATH_HREF_CARPETA_LUGARES_INTERES . "/paseo-maritimo-castro-urdiales/img/paseo-maritimo-castro-urdiales-1.jpg" ?>
                 class="w-full h-full object-cover rounded-md">
          </div>
          <div class="swiper-slide h-72">
            <img src=<?= PATH_HREF_CARPETA_LUGARES_INTERES . "/paseo-maritimo-castro-urdiales/img/paseo-maritimo-castro-urdiales-2.jpg" ?>
                 class="w-full h-full object-cover rounded-md">
          </div>
          <div class="swiper-slide h-72">
            <img src=<?= PATH_HREF_CARPETA_LUGARES_INTERES . "/paseo-maritimo-castro-urdiales/img/paseo-maritimo-castro-urdiales-1.jpg" ?>
