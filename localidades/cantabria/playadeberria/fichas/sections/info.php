...
$li_encabezado = '
<section id="playa-berria">
  <p>
    <i class="fas fa-umbrella-beach" style="color: #e67e22;"></i>
    <strong>Descubre la Playa de Berria</strong>, una de las más conocidas y visitadas de la costa cantábrica en Cantabria.
    <br>Con su amplia extensión de arena dorada y aguas limpias, la playa es ideal para disfrutar de actividades acuáticas como el surf y el kitesurf.
    <br>Su entorno natural, rodeado de dunas y vegetación autóctona, la convierte en un lugar perfecto para relajarse y disfrutar de la belleza del paisaje.
    <br>La playa es también un lugar adecuado para familias, con zonas tranquilas y restaurantes cercanos que ofrecen platos típicos de la región.
  </p>
  <p>
...
<section id="playa-berria" class="section-playa">
    ...
    <ul>
        <li class="my-4">
            <i class="fas fa-life-ring" style="color: #e74c3c;"></i> <strong>Seguridad:</strong> <br> La playa cuenta con socorristas certificados durante la temporada alta. Además, está completamente señalizada y vigilada para ofrecerte tranquilidad mientras disfrutas del mar.
        </li>
        <li class="my-4">
            <i class="fas fa-wheelchair" style="color: #9b59b6;"></i> <strong>Accesibilidad:</strong> <br> Rampas de acceso y pasarelas de madera, junto con baños adaptados, permiten a las personas con movilidad reducida disfrutar del entorno de forma cómoda.
        </li>
    </ul>
</section>
';
...
<?php $li_mapa_ubicacion = '
    <p><strong>Situada en el norte de Cantabria</strong>, la Playa de Berria es fácilmente accesible desde diferentes puntos de la región. A continuación, te mostramos las opciones más cómodas para llegar hasta ella:</p>
    ...
    <h3><i class="fas fa-map-marked-alt" style="color:#9b59b6;"></i> Mapa interactivo de la Playa de Berria</h3>
    <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2920.954508765897!2d-3.7342151842536696!3d43.45587537912983!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd491701e8553aab%3A0x123456789abcd!2sPlaya%20de%20Berria!5e0!3m2!1ses!2ses!4v1693554912315!5m2!1ses!2ses"
...
$li_actividades_recomendadas = '
    <div class="info-box">
        <ul>
            <li class="my-4">
                <span class="highlight"><i class="fas fa-surfing" style="color: #2980b9;"></i> <strong>Surf:</strong></span> <br>
                La Playa de Berria es conocida por sus excelentes condiciones para el surf, con olas que atraen tanto a principiantes como a surfistas experimentados. Hay varias <a href="https://www.berriasurfschool.com/" target="_blank" rel="noopener noreferrer">escuelas de surf</a> en la zona que ofrecen clases y alquiler de equipos.
            </li>
            <li class="my-4">
                <span class="highlight"><i class="fas fa-wind" style="color: #8e44ad;"></i> <strong>Kitesurf:</strong></span> <br>
                La playa también es un lugar popular para el kitesurf, gracias a sus amplios espacios y buenas condiciones de viento. Si deseas aprender, puedes consultar <a href="https://www.berriasurfschool.com/kitesurf/" target="_blank" rel="noopener noreferrer">clases de kitesurf</a>.
            </li>
            <li class="my-4">
                <span class="highlight"><i class="fas fa-hiking" style="color: #27ae60;"></i> <strong>Senderismo:</strong></span> <br>
                Explora las rutas de senderismo que rodean la playa, incluyendo caminos que ofrecen vistas panorámicas del mar y del paisaje costero. Para más información sobre rutas cercanas, visita <a href="https://www.rutasdecantabria.com/" target="_blank" rel="noopener noreferrer">rutas de senderismo en Cantabria</a>.
            </li>
';
...
$li_actividades_recomendadas2 = '
            ...
            <li class="my-4">
                ...
                Disfruta de paseos en bicicleta por las rutas cercanas a la playa, ideales para explorar el entorno natural y disfrutar del paisaje costero. Para alquileres de bicicletas y rutas, visita <a href="https://www.cicloturismo.com/" target="_blank" rel="noopener noreferrer">Cicloturismo Cantabria</a>.
            </li>
        </ul>
    </div>
'; 
...
$faq = '
    <div class="faq">
        ...
        <dl>
            <dt><i class="fas fa-question-circle"></i> ¿Cuáles son las mejores actividades en la Playa de Ostende?</dt>
            <dd><i class="fas fa-check-circle"></i> Surf, kitesurf, senderismo, observación de aves, pesca y paseos en bicicleta.</dd>
            <dt><i class="fas fa-question-circle"></i> ¿La playa es apta para familias?</dt>
            <dd><i class="fas fa-check-circle"></i> Sí, es ideal para familias, con servicios como duchas, baños y zonas de juegos.</dd>
            <dt><i class="fas fa-question-circle"></i> ¿Hay escuelas de surf cerca?</dt>
            <dd><i class="fas fa-check-circle"></i> Sí, varias escuelas ofrecen clases y alquiler de equipos en la zona.</dd>
        </dl>
    </div>
';?>
...
$schema_json = '
    <script type="application/ld+json">
    {
        ...
        "address": {
            "@type": "PostalAddress",
            "streetAddress": "Playa de Ostende, Castro-Urdiales",
        ...
        "telephone": "+34 942 51 12 34",
        "url": "https://www.playadeostende.com",
        "image": "https://www.playadeostende.com/images/playa-ostende.jpg",
        "description": "La Playa de Ostende es una playa urbana ubicada en Castro-Urdiales, Cantabria, conocida por sus excelentes condiciones para el surf y otras actividades acuáticas.",
        "openingHours": "Mo-Su 08:00-20:00",
        "sameAs": [
            "https://www.facebook.com/playadeostende",
            "https://twitter.com/playadeostende"
        ]
    }
    </script>
';
    ...
    <div class="info-box">
        ...
        <ul>
            <li class="my-4">
                ...
                <a href="tel:+34942660101">+34 942 66 01 01</a>
            </li>
            <li class="my-4">
                <i class="fas fa-envelope" style="color: #e67e22;"></i> <strong>Email:</strong> <br>
                <a href="mailto:turismo@aytosantona.org">turismo@aytosantona.org</a>
            </li>
            <li class="my-4">
        ...
        <p>También puedes seguir las últimas noticias, eventos y recomendaciones en redes sociales, o consultar el <a href="https://turismodecantabria.com/municipios/santona/" target="_blank" rel="noopener noreferrer"><strong>portal oficial de turismo de Cantabria</strong></a>.</p>
    </div>
'; ?>
...
<div class="info-box">
    <ul>
        <li class="my-4">
            ...
            Servicio de socorrismo activo durante la temporada alta para la seguridad de los bañistas en la Playa de Ostende, Castro-Urdiales.
        </li>
        <li class="my-4">
            <i class="fas fa-wheelchair" style="color:#2980b9;"></i>
            <span class="highlight">Accesibilidad:</span><br>
            Accesos adaptados para personas con movilidad reducida, incluyendo pasarelas y sillas anfibias.
        </li>
        <li class="my-4">
            <i class="fas fa-shower" style="color:#27ae60;"></i>
            <span class="highlight">Duchas y baños:</span><br>
            Instalaciones higiénicas disponibles a lo largo del paseo marítimo.
        </li>
...
<?php $li_services2 = '
        <li class="my-4">
            ...
            Zonas de aparcamiento gratuito y reservadas para PMR cerca de la Playa de Ostende.
        </li>
        <li class="my-4">
            <i class="fas fa-umbrella-beach" style="color:#8e44ad;"></i>
            <span class="highlight">Alquiler de sombrillas y hamacas:</span><br>
            Servicios disponibles en verano para mejorar tu confort junto al mar.
        </li>
...
<?php $li_services3 = '
        <li class="my-4">
            <i class="fas fa-cocktail" style="color:#c0392b;"></i>
            <span class="highlight">Chiringuitos:</span><br>
            Opción de bebidas, tapas y comidas ligeras con vistas al mar Cantábrico.
        </li>
        <li class="my-4">
            <i class="fas fa-water" style="color:#16a085;"></i>
            <span class="highlight">Actividades náuticas:</span><br>
            Posibilidad de practicar surf, paddle surf y kayak, especialmente en zonas con más oleaje.
        </li>
    </ul>
</div>
';?>
...
<ul>
    ...
    <li class="my-4">
        ...
        <strong>Conciertos de Verano:</strong><br>
        Durante los meses de julio y agosto, se organizan actuaciones musicales al aire libre en la zona de la playa y el paseo marítimo. <a href="https://www.santona.es/agenda/" target="_blank" rel="noopener noreferrer">Consulta el calendario</a>.
    </li>
    <li class="my-4">
        <i class="fas fa-umbrella-beach" style="color: #e67e22;"></i>
        <strong>Eventos en Chiringuitos:</strong><br>
        Los chiringuitos de la Playa de Berria, como "Er Chiringo Titi Caca", organizan fiestas temáticas y eventos especiales durante el verano. <a href="https://www.facebook.com/p/ER-CHIRINGO-TITI-CACA-BERRIA-100057187340821/" target="_blank" rel="noopener noreferrer">Más información</a>.
    </li>
</ul>
';
?>
