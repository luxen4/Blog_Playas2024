...
<head>
  ...
  <title>Eventos en la Playa de Berria – Santoña</title>
  ...
  <meta name="keywords" content="Eventos Playa Berria, fiestas Santoña, surf Berria, mercado verano Cantabria, Parque Natural Marismas" />
  <meta name="robots" content="index, follow" />
  <meta name="date" content="2025-05-11" />

  <!-- Open Graph -->
  <meta property="og:title" content="Eventos en la Playa de Berria – Santoña" />
  <meta property="og:description" content="Vive experiencias únicas en Berria: conciertos, surf, ferias artesanas y rutas por el Parque Natural de las Marismas de Santoña." />
  ...
  <meta name="twitter:title" content="Eventos en la Playa de Berria – Santoña" />
  <meta name="twitter:description" content="Actividades culturales, surf y mercadillos en Berria, junto al Parque Natural de Santoña." />
...
<body>
  ...
  <section id="eventos" class="container py-5">
    <header class="text-center mb-4">
      ...
      <p>Disfruta de <strong>naturaleza, cultura y deporte</strong> en uno de los entornos costeros más bellos de <a href="https://es.wikipedia.org/wiki/Santoña" title="Santoña">Santoña</a>, junto al Parque Natural de las Marismas. Aquí te presentamos los eventos más destacados del verano.</p>
    </header>
    ...
    <div class="event-box">
      <ul class="list-unstyled">
        ...
        <li class="my-4">
          ...
          Excursiones ecológicas con guías especializados para descubrir aves migratorias y flora autóctona de las marismas de Santoña.
        </li>
      ...
      <p>¿Te interesa explorar más actividades en Santoña? Visita nuestra <a href="/agenda-cultural/" title="Agenda cultural en Cantabria">agenda cultural</a>.</p>
    </div>
  </section>
  ';
