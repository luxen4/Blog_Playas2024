...
<section class="py-5">
  <div class="container">
    ...
    <div class="faq-section">
      <dl>
        <dt><i class="fas fa-question-circle" style="color: #3498db;"></i> ¿Cómo es la arena de la Playa de Berria?</dt>
        <dd><i class="fas fa-check-circle" style="color: #2ecc71;"></i> Arena fina y dorada con amplias zonas para pasear, hacer castillos o tumbarse al sol.</dd>

        <dt><i class="fas fa-question-circle" style="color: #3498db;"></i> ¿Tiene acceso adaptado?</dt>
        <dd><i class="fas fa-check-circle" style="color: #2ecc71;"></i> Sí, la playa está equipada con rampas, pasarelas y aseos adaptados para personas con movilidad reducida.</dd>

        <dt><i class="fas fa-question-circle" style="color: #3498db;"></i> ¿Se pueden practicar deportes acuáticos?</dt>
        <dd><i class="fas fa-check-circle" style="color: #2ecc71;"></i> Es una playa muy popular para el <a href="/surf-en-cantabria/" title="Surf en Cantabria">surf</a>, bodyboard y paddle surf, con escuelas locales disponibles.</dd>

        <dt><i class="fas fa-question-circle" style="color: #3498db;"></i> ¿Cuenta con servicios?</dt>
        <dd><i class="fas fa-check-circle" style="color: #2ecc71;"></i> Sí, dispone de socorristas, duchas, aseos, aparcamiento cercano y algunos chiringuitos en verano.</dd>

        <dt><i class="fas fa-question-circle" style="color: #3498db;"></i> ¿Dónde obtener más información?</dt>
        <dd><i class="fas fa-check-circle" style="color: #2ecc71;"></i> Consulta la <a href="./caracteristicas-playa-de-berria.php" title="Guía Playa de Berria">guía completa de la Playa de Berria</a> para todos los detalles actualizados.</dd>
      </dl>
    </div>
    ...
    <header class="section-header">
      ...
      <p class="lead">Prepara tu día en Berria con estos tips locales</p>
    </header>
    <div class="consejos-section">
      <ul class="list-unstyled">
        <li class="my-4">
          ...
          La mejor época es de <time datetime="2025-06">junio</time> a <time datetime="2025-09">septiembre</time>, pero la primavera y el otoño también son agradables y más tranquilos.
        </li>
        <li class="my-4">
          <i class="fas fa-umbrella-beach" style="color: #f39c12;"></i>
          <strong>¿Qué llevar?</strong><br>
          Protector solar, bañador, sombrilla, algo de comida, y si practicas surf, tu equipo o alquílalo en la escuela local.
        </li>
        <li class="my-4">
