<script type="application/ld+json">
{
  ...
  "url": "https://<?= $_SERVER['SERVER_NAME'] ?>/Blog_Playas2024/localidades/<?= $region_minuscula ?>/<?= $carpeta; ?>/fichas/playa-de-<?= $nombre_playa_minuscula . "-" . $localidad_minuscula . "-" . $region_minuscula ?>.php",
  "touristType": {
    "@type": "Audience",
