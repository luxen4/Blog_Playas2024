...
$li_encabezado = '
    <p><strong>Descubre la <a href="https://turismodecantabria.com/playas/playa-de-ostende-o-urdiales/" target="_blank" title="Visita la Playa de Ostende en Cantabria">Playa de Ostende en Cantabria</a></strong>, uno de los destinos costeros más hermosos del norte de España. 
...
<?php $id = 'id="informacion_general"'; ?>
<?php $li_descripcion_detallada = '
<section ' . $id . ' class=""> 
    <p class="section-content">La Playa de Ostende, ubicada en la costa de Cantabria, es un paraíso de belleza natural y confort. Con su amplia franja de arena dorada y aguas tranquilas, es el lugar perfecto para relajarse y disfrutar de deportes acuáticos. Rodeada de un entorno natural impresionante, es un refugio ideal para los amantes de la naturaleza.</p>
    <p class="section-content">Ostende ofrece una variedad de servicios, incluyendo restaurantes y tiendas cercanas, así como un agradable paseo marítimo que invita a disfrutar del paisaje. Durante el verano, se organizan mercadillos locales que enriquecen la experiencia de los visitantes.</p>

    <h3>Seguridad y Accesibilidad</h3>
    <ul>
        <li class="my-4"><strong>Seguridad:</strong> <br>Socorristas disponibles durante la temporada alta.</li>
        <li class="my-4"><strong>Accesibilidad:</strong> <br>Rampas y sillas anfibias para facilitar el acceso a personas con movilidad reducida.</li>
    </ul>
';
?>
...
<section id="descripcion-ostende" class="seccion-descripcion container py-4">
  ...
  <ul>
    ...
    <li class="my-4">
      <i class="fas fa-wheelchair" style="color: #9b59b6;"></i> <strong>Accesibilidad:</strong> <br>Accesos adaptados con rampas, pasarelas y baños para personas con movilidad reducida, asegurando que todos puedan disfrutar del lugar.
    </li>
  </ul>
</section>
';
...
<section id="actividades-ostende" class="container py-4">
  ...
  <p class="section-content">
    Además, Ostende cuenta con diversas <a href="https://escuelasurf.com/" target="_blank" rel="noopener noreferrer" title="Escuelas de Surf">escuelas de surf</a> y alquiler de equipos para quienes deseen aprender o mejorar sus habilidades acuáticas.
  </p>
  <p class="section-content">
...
<section id="consejos-visita-ostende" class="container py-4">
  ...
  <ul>
    ...
    <li class="my-4">
      ...
      No te pierdas el <a href="https://www.turismodecantabria.com/descubrela/recursos/687-playa-de-loredo" target="_blank" rel="noopener noreferrer">Parque Natural de las Dunas de Liencres</a> o disfruta de un paseo por <a href="https://turismo.santander.es/" target="_blank" rel="noopener noreferrer">Santander</a> a menos de 30 minutos en barco.
    </li>
  </ul>
</section>
';
...
<?php
$li_mapa_ubicacion = '
<section id="como-llegar" class="seccion-mapa container py-4">

  <p>La <strong>Playa de Ostende</strong>, situada en <a href="/castro-urdiales/" title="Descubre Castro Urdiales">Castro Urdiales</a>, es una de las playas mejor comunicadas de la costa cántabra. A continuación te explicamos cómo llegar:</p>

  <ul class="list-unstyled">
    <li class="my-4">
      <strong>🚗 En coche:</strong><br>
      Desde <strong>Santander</strong>, accede por la <abbr title="Autovía del Cantábrico">A-67</abbr> en apenas <time datetime="PT25M">25 minutos</time>. La zona cuenta con <strong>aparcamientos gratuitos y de pago</strong> cercanos a la playa.
    </li>
    <li class="my-4">
      <strong>🚌 En autobús:</strong><br>
      Castro-Urdiales está conectado mediante <strong>líneas regulares de autobús</strong> con Bilbao, Santander y otras ciudades del norte. Las paradas están a escasos minutos andando de la playa.
    </li>
    <li class="my-4">
      <strong>🚴 A pie o en bicicleta:</strong><br>
      Disfruta de un acceso ecológico por <strong>senderos costeros y carriles bici</strong> señalizados. Una opción perfecta para los amantes del <em>slow tourism</em> y del medio ambiente.
    </li>
  </ul>
  ...
  <p class="mt-3">
    ¿Vienes desde otra zona? Usa <a href="https://www.google.com/maps/dir//Playa+de+Ostende" target="_blank" rel="noopener noreferrer" title="Cómo llegar a la Playa de Ostende en Google Maps">Google Maps para calcular tu ruta</a> desde cualquier punto.
  </p>
</section>
';
?>
  ...
  <div class="info-box">
    <ul class="list-unstyled">
      <li class="my-4">
        ...
        La Playa de Ostende es perfecta para <strong>surf, paddle surf y windsurf</strong>. Dispone de <a href="https://www.surfcantabria.com" target="_blank" rel="noopener" title="Escuelas de surf en Cantabria">escuelas especializadas</a> con monitores certificados y <strong>alquiler de material deportivo</strong>. Actividades disponibles desde <time datetime="2025-05">mayo</time> hasta <time datetime="2025-09">septiembre</time>.
      </li>
      <li class="my-4">
...
$li_actividades_recomendadas2 = '
      <li class="my-4">
        <i class="fas fa-volleyball-ball" style="color: #e67e22;"></i>
        <strong>Zonas Deportivas junto al mar:</strong><br>
        En la playa hay <strong>espacios deportivos al aire libre</strong> para <strong>voleibol de playa, fútbol y yoga</strong>. Ideales para familias, grupos y visitantes que buscan ejercicio con vistas al mar.
      </li>
      <li class="my-4">
        <i class="fas fa-ship" style="color: #3498db;"></i>
        <strong>Excursiones en barco desde Ostende:</strong><br>
        Participa en <a href="/excursiones-en-barco-cantabria/" title="Rutas en barco por Cantabria">rutas marítimas guiadas</a> y descubre calas escondidas, acantilados y la fauna del mar Cantábrico. Disponibles todo el año, especialmente en temporada alta.
      </li>
    </ul>
  </div>';
...
<?php
$li_mas_info = '
  <p>¿Tienes dudas sobre cómo llegar, servicios o actividades en la <strong>Playa de Ostende en Castro-Urdiales</strong>? Aquí te dejamos los datos de contacto oficiales:</p>
  <ul class="list-unstyled">

    <li class="my-4">
      <i class="fas fa-phone-alt" style="color: #3498db;"></i> 
      <strong>Teléfono de Atención Turística:</strong><br>
      <a href="tel:+34942203000" title="Llamar a la Oficina de Turismo de Castro Urdiales">+34 942 203 000</a>
    </li>

    <li class="my-4">
      <i class="fas fa-envelope" style="color: #3498db;"></i> 
      <strong>Email de Contacto:</strong><br>
      <a href="mailto:info@castrourdialesturismo.com" title="Escribir a la Oficina de Turismo de Castro Urdiales">info@castrourdialesturismo.com</a>
    </li>

    <li class="my-4">
      <i class="fas fa-map-marker-alt" style="color: #3498db;"></i> 
      <strong>Oficina de Turismo de Castro-Urdiales:</strong><br>
      Calle del Mar, 1, 39700 Castro Urdiales, Cantabria<br>
      <a href="https://turismodecantabria.com/playas/playa-de-ostende-o-urdiales/" target="_blank" rel="noopener" title="Información oficial en Turismo de Cantabria">
        <strong>Visita la web oficial de Turismo de Cantabria</strong>
      </a>
    </li>
  </ul>

  <p>También puedes consultar nuestra <a href="/como-llegar-playa-ostende/" title="Cómo llegar a la Playa de Ostende">guía para llegar a la Playa de Ostende</a> o descubrir <a href="/playas-de-cantabria/" title="Playas recomendadas en Cantabria">otras playas de Cantabria</a>.</p>
...
<?php
$li_services = '
<section id="servicios-playa-ostende">
  <p>En la <strong>Playa de Ostende de Castro-Urdiales (Cantabria)</strong> encontrarás una amplia gama de <strong>servicios pensados para tu confort</strong> y una experiencia completa frente al mar Cantábrico.</p>
  <ul class="list-unstyled">
...
$imagenes = [
    [
        'src' => $ruta . './../img/playa-Ostende-Castro-Urdiales.jpg',
    ...
    [
        'src' => $ruta . '/atardecer-playa-Ostende-Castro-Urdiales-Cantabria.jpg',
    ...
    [
        'src' => $ruta . '/deportes-acuaticos-Castro-Urdiales-Cantabria.png',
    ...
    [
        'src' => $ruta . '/familias-disfrutando-playa-Ostende-Castro-Urdiales-Cantabria.jpg',
    ...
    [
        'src' => $ruta . '/paseo-maritimo-playa-Ostende-Castro-Urdiales-Cantabria.jpg',
    ...
    [
        'src' => $ruta . '/rocas-playa-Ostende-Castro-Urdiales-Cantabria.jpg',
