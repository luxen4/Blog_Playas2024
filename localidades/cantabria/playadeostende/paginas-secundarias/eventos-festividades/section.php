...
<header class="text-center mb-4">
  <h1 class="text-warning">🎉 Eventos y Festividades en la Playa de Ostende</h1>
  <p>
    Vive las <strong>mejores celebraciones junto al mar</strong> en la 
    <a href="https://es.wikipedia.org/wiki/Playa_de_Ostende" title="Más sobre la Playa de Ostende">
      Playa de Ostende
    </a> en 
    <a href="https://es.wikipedia.org/wiki/Castro-Urdiales" title="Más sobre Castro Urdiales">
      Castro Urdiales, Cantabria
    </a>. Conciertos, fiestas populares, actividades culturales y eventos veraniegos que llenan de vida este enclave costero.
  </p>
</header>
