...
define('PATH_RAIZ_LOCALIDADES_CARPETA', PATH_RAIZ. "/localidades/{$region_minuscula}/{$localidad_minuscula}"); 
...
define('PATH_HREF_CARPETA', "/Blog_Playas2025/localidades/{$region_minuscula}/{$localidad_minuscula}");
