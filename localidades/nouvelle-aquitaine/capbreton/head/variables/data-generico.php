<?php
    ...
    $carpeta = 'plage-centrale-capbreton';  // slug de la playa
    ...
    $mainEntity_image = PATH_RAIZ_LOCALIDADES_CARPETA . "/{$region_minuscula}/{$carpeta}/img/plage-centrale-capbreton.jpg";
