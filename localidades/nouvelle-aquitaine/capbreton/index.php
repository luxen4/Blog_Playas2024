...
<?php require PATH_RAIZ_LOCALIDADES . "/nouvelle-aquitaine/capbreton/head/variables/_meta_tagsa.php"; ?>
...
lugar_minuscula_footer = 'Capbreton, Nouvelle Aquitaine'; 
COLOR_PAGE='blue'; 
lugar_minuscula='Capbreton'; 
lugar_minuscula='Capbreton';
