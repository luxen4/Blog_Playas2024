<?php $li_encabezado = '
<h1 class="text-center">Playa de Getxo</h1>
<p class="text-center">Descubre la Playa de Getxo, un destino emblemático en la costa de Bizkaia. Con su arena dorada y amplias instalaciones, es el lugar perfecto para disfrutar del sol y practicar deportes acuáticos. Además, su vibrante paseo marítimo está repleto de bares y restaurantes, ofreciendo una rica oferta gastronómica y cultural que hará de tu visita una experiencia inolvidable.</p>
'; ?>
...
<?php $li_descripcion_detallada3 = '
    ...
    <p>Getxo acoge varios eventos a lo largo del año que atraen tanto a locales como a turistas:</p>
        <ul>
            <li><span class="highlight">Festival Internacional de Jazz de Getxo:</span> Celebrado en julio, este festival trae a grandes músicos de jazz de todo el mundo.</li>
...
<?php $li_mapa_ubicacion = '
    ...
    <ul>
        ...
        <li><strong>En metro:</strong> La playa está bien conectada mediante la línea 1 del metro de Bilbao, con la estación de Getxo a solo unos minutos a pie de la playa.</li>
        <li><strong>A pie o en bicicleta:</strong> Getxo y sus alrededores cuentan con una red de rutas peatonales y carriles bici que facilitan el acceso a la playa. Es una opción ideal para disfrutar del paisaje y el aire libre.</li>
    </ul>
    <h3>Mapa de la Playa de Getxo</h3>
    <iframe
...
<?php $li_mas_info = '
    ...
    <ul>
        ...
        <li><strong>Email:</strong> turismo@getxo.eus</li>
        <li><strong>Oficina de Turismo:</strong> Plaza Estación, 1, 48930 Getxo, Bizkaia
            <a href="https://www.getxo.eus/es/turismo"><strong>Web</strong></a>
        </li>
    </ul>
'; ?>
