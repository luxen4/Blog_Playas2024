...
<?php 
$li_mapa_ubicacion = '
    <p>La Playa de Muskiz, también conocida como Playa de La Arena, es de fácil acceso tanto en coche como en transporte público.</p>
    <ul>
        <li class="my-4"><strong>En coche:</strong> <br>Desde Bilbao, la Playa de Muskiz se encuentra a unos 25 minutos en coche por la carretera BI-634 o la autovía A-8. Hay amplias zonas de aparcamiento cerca de la playa, aunque pueden llenarse durante los días más concurridos.</li>
    ...
    <div class="row mt-4">
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <img style="height: 200px;" src="./../img/surf-playa-Muskiz-Bizkaia-País-Vasco.png" class="card-img-top" alt="Surf en la Playa de Muskiz">
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <img style="height: 200px;" src="./../img/mapa-senderismo-Muskiz-Bizkaia-País-Vasco.png" class="card-img-top" alt="Senderismo en Muskiz">
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <img style="height: 200px;" src="./../img/voley-playa-Muskiz-Bizkaia-País-Vasco.jpg" class="card-img-top" alt="Vóley playa en Muskiz">
                <div class="card-body">
...
<?php $li_mas_info = '
    <ul>
        <li class="my-4"><strong>Teléfono:</strong> <br>+34 946 706 513</li>
        <li class="my-4"><strong>Email:</strong> <br>turismo@muskiz.org</li>
        <li class="my-4"><strong>Oficina de Turismo:</strong> <br>Plaza Meatzari, 1, 48550 Muskiz, Bizkaia
            <a href="https://www.muskiz.org/es-ES/Turismo"><strong>Web</strong>
        </li>
    </ul>
'; ?>
...
<?php $li_services = '
    ...
    <div class="row mt-4">
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <img style="height: 200px;" src="./../img/servicio-socorrismo-playa-Muskiz-Bizkaia-País-Vasco.webp" class="card-img-top" alt="Servicios de socorrismo en la Playa de Muskiz">
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <img style="height: 200px;" src="./../img/acceso-playa-Muskiz-Bizkaia-País-Vasco.png" class="card-img-top" alt="Accesibilidad en la Playa de Muskiz">
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <img style="height: 200px;" src="./../img/bar-cafeteria-en-la-playa-Muskiz-Bizkaia-País-Vasco.jfif" class="card-img-top" alt="Restauración en la Playa de Muskiz">
                <div class="card-body">
