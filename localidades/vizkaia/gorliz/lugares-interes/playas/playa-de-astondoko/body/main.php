<main>
  <h1 class="text-2xl md:text-3xl font-semibold text-blue-600 mb-4">
    ...
    <span class="block mt-1 text-base md:text-lg text-blue-500 font-normal">
      Naturaleza, tranquilidad y mar junto a Gorliz, en la costa de Vizkaia
    </span>
  </h1>

  <p class="mb-4 text-sm text-gray-700">
    <strong class="text-gray-900">Playa de Astondoko</strong>, ubicada en el extremo oriental de la <span class="font-medium">Playa de Gorliz</span> (vizkaia), es un rincón costero de gran valor ecológico y paisajístico. Protegida por dunas naturales y colinas verdes, es perfecta para quienes buscan un entorno tranquilo, ideal para relajarse, caminar o practicar deportes acuáticos.
  </p>
  ...
  <p class="mb-4 text-sm text-gray-700">
    Explora este rincón especial de la costa de vizkaia, donde el mar y la naturaleza se encuentran en armonía.
  </p>
  ...
  <section class="mb-6 text-gray-700">
    ...
    <ul class="list-none pl-0 space-y-1 text-gray-700 mb-6">
      <li>
        <strong>Municipio:</strong> Gorliz (Vizkaia)
      </li>
      <li>
