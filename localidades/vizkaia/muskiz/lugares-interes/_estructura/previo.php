...
define('PATH_RAIZ_CARPETA_LUGARES_CARPETA_LUGAR', PATH_RAIZ_CARPETA_LOCALIDADES_LUGARES_INTERES. "/{$carpeta_lugar}"); 
...
define('PATH_HREF_CARPETA_IMAGENES', PATH_HREF_CARPETA_LUGARES_INTERES. "/{$carpeta_lugar}/imagenes");
?>
