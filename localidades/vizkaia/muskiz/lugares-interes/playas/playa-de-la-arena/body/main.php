<main>
  <h1 class="text-2xl md:text-3xl font-semibold text-blue-600 mb-4">
    ...
    <span class="block mt-1 text-base md:text-lg text-blue-500 font-normal">
      Un extenso arenal entre vizkaia y Cantabria
    </span>
  </h1>

  <p class="mb-4 text-sm text-gray-700">
    La <strong class="text-gray-900">Playa de La Arena</strong>, situada en el municipio de <span class="font-medium">Muskiz</span>, vizkaia, es una de las playas más amplias del litoral vasco. Rodeada de dunas, praderas y con vistas al monte, es ideal para familias, surfistas y amantes del paseo marítimo.
  </p>
  ...
  <p class="mb-4 text-sm text-gray-700">Imágenes de la Playa de La Arena en Muskiz, vizkaia</p>
