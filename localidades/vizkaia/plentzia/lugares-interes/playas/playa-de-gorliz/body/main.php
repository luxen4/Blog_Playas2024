<main>
  <h1 class="text-2xl md:text-3xl font-semibold text-blue-600 mb-4">
    ...
    <span class="block mt-1 text-base md:text-lg text-blue-500 font-normal">
      Un rincón costero ideal para familias y deportes acuáticos en vizkaia
    </span>
  </h1>

  <p class="mb-4 text-sm text-gray-700">
    La <strong class="text-gray-900">Playa de Gorliz</strong>, situada en el municipio de <span class="font-medium">Gorliz</span>, vizkaia, es una playa amplia de arena fina y dorada, perfecta para familias y amantes de los deportes acuáticos. Cuenta con un agradable paseo marítimo y un entorno natural muy cuidado.
  </p>
  ...
  <p class="mb-4 text-sm text-gray-700">Imágenes de la Playa de Gorliz, vizkaia</p>
