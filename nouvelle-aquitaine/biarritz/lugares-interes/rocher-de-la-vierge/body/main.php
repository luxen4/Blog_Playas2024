<main>
  ...
  <figure class="grid grid-cols-1 md:grid-cols-2 gap-4 my-8">
    <img src="<?php echo PATH_HREF_RAIZ_LOCALIDAD_LUGARES_INTERES_IMG; ?>/rocher-de-la-vierge-nouvelle-aquitaine-2.jpg"
         alt="Vista del Rocher de la Vierge en Biarritz"
         class="aspect-video object-cover w-full rounded-lg shadow-sm" loading="lazy">
    <img src="<?php echo PATH_HREF_RAIZ_LOCALIDAD_LUGARES_INTERES_IMG; ?>/rocher-de-la-vierge-nouvelle-aquitaine-.jpg"
