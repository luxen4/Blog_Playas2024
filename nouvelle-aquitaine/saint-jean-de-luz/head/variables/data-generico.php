<?php
    // Datos principales para Saint-Jean-de-Luz
    ...
    // Coordenadas aproximadas del centro de Saint-Jean-de-Luz
    $mainEntity_geo_latitude    = 43.3886;
    $mainEntity_geo_longitude   = -1.6621;

    // Imagen representativa y URL canónica para Saint-Jean-de-Luz
    $mainEntity_image = PATH_LOCALIDAD . "/{$region_minuscula}/{$localidad_minuscula}/img/saint-jean-de-luz.jpg";
